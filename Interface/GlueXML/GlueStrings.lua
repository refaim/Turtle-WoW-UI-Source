...
ABILITY_INFO_GOBLIN4 = "- Increased movement speed for a short duration.";
...
BF_NOT_IN = "You are not currently in a battleground"; -- G-15
BF_RANK = "Rank"; -- G-15
...
LOGIN_BANNED = "This World of Warcraft account has been closed and is no longer available for use."; -- This is the error message players get when trying to log in with a banned account. -- This is the error message players get when trying to log in with a banned account.
...
LOGIN_SUSPENDED = "This account has been temporarily suspended. Please, read the Terms of Use on our website."; -- This is the error message a player receives when trying to log in with a suspended account.
LOGIN_UNKNOWN_ACCOUNT = "The information you have entered is not valid.";
LOGIN_UNKNOWN_ACCOUNT_CALL = "UwU >'.'< OwO";
...
SERVER_ALERT_URL = "http://turtle-wow.org/alert.php";
SERVER_DOWN = "Server down";
SERVER_SELECTION = "Realm Selection";
SKILLLINES = "Skill Lines";
SOUL_SHARD = "SOUL SHARDS %d"; -- G-15
