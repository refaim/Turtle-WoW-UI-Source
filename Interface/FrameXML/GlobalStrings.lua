...
CHAT_HARDCORE_GET = "[Hardcore] %s:\32"; -- Hardcore chat message from player %s
...
CHAT_HARDCORE_SEND = "Hardcore:\32"; -- Chat message to hardcore homies
...
GUILD_MESSAGE = "Guild"; -- Message to your guild
HARDCORE_MESSAGE = "Hardcore"; -- Message to your Hardcore homies
...
HELPFRAME_HOME_TEXT = "You don't need to be online for your ticket to be resolved."; -- Greeting text on the home tab of the HelpFrame
...
MACRO_POPUP_TEXT = "Enter Macro Name:"; -- Text for the macro popup
...
PARTY_MESSAGE = "Party"; -- Message to your party
...
PVP_MEDAL25 = "Warden of the Ley Lines";
